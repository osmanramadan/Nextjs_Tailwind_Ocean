  ...
  return (
    <div>
      {features.map((feature, index) => (
        <div key={index} className="h-33 mt-4  lg:py-6 px-3 flex flex-col lg:flex-row justify-between items-center  group hover:!bg-[#1E293B] hover:border-[#0284C7] cursor-pointer hover:!border-[0.9px] hover:rounded-lg">
        <div className="group-hover:!bg-[#1E293B] px-7">
            <img
                src={feature.image}
                alt={feature.title}
                className="group-hover:!bg-[#1E293B] h-12 w-25"
            />
        </div>
